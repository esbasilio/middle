 ...
 * @Date:   2020-07-14 20:41:52
 * @Last Modified by:   Beto
 * @Last Modified time: 2020-07-17 12:06:20
 */
...
class CronExpression
{
    ...
    /**
     * Determine if the cron is run to run based on the current date or a
     ...
     * @param null|string               $timeZone    TimeZone to use instead of the system default
     *
     * @return bool Returns TRUE if the cron is run to run or FALSE if not
     */
    public function isRunDate($currentTime = 'now', $timeZone = null): ?bool
    {
