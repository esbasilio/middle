    ...
    public function list(Request $request): Response
    {
        ...
        if (!empty($columns)) {
            foreach ($columns as $column) {
                ...
                } elseif (is_numeric($search_value) && $column['name'] != 'o.reference_id') {
                    $condition_type = 'eq';
                }
        ...
        $query = $this->getDoctrine()->getRepository(OrderHistory::class)->findByPage($page_current, $length, $search_data, $colum_order);
